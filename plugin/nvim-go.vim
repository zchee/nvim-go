...
\ {'type': 'command', 'name': 'DlvBreakpoint', 'sync': 1, 'opts': {'complete': 'customlist,DelveFunctionList', 'nargs': '+'}},
\ {'type': 'command', 'name': 'DlvContinue', 'sync': 0, 'opts': {}},
\ {'type': 'command', 'name': 'DlvDetach', 'sync': 0, 'opts': {}},
\ {'type': 'command', 'name': 'DlvDisassemble', 'sync': 1, 'opts': {}},
\ {'type': 'command', 'name': 'DlvKill', 'sync': 0, 'opts': {}},
\ {'type': 'command', 'name': 'DlvNext', 'sync': 0, 'opts': {}},
\ {'type': 'command', 'name': 'DlvRestart', 'sync': 0, 'opts': {}},
\ {'type': 'command', 'name': 'DlvStartClient', 'sync': 1, 'opts': {'eval': '[getcwd(), expand(''%:p:h'')]'}},
\ {'type': 'command', 'name': 'DlvStartServer', 'sync': 0, 'opts': {'complete': 'file', 'eval': '[getcwd(), expand(''%:p:h'')]', 'nargs': '*'}},
\ {'type': 'command', 'name': 'DlvStdin', 'sync': 0, 'opts': {'nargs': '+'}},
\ {'type': 'command', 'name': 'DlvStep', 'sync': 0, 'opts': {}},
\ {'type': 'command', 'name': 'DlvStepInstruction', 'sync': 0, 'opts': {}},
...
\ {'type': 'function', 'name': 'DelveFunctionList', 'sync': 1, 'opts': {}},
