...
\ {'type': 'autocmd', 'name': 'WinEnter', 'sync': 1, 'opts': {'eval': '{''BufNr'': bufnr(''%''), ''WinID'': win_getid(), ''Dir'': expand(''%:p:h'')}', 'group': 'nvim-go-autocmd', 'pattern': '*.go'}},
